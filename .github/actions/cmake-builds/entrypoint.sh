...
CMAKE_OPTIONS="-DCMAKE_CONFIGURATION_TYPE:STRING="
if [ "x$INPUT_CMAKE_CONFIGURATION_TYPE" == 'x' ]; then
	INPUT_CMAKE_CONFIGURATION_TYPE="Debug"
fi
CMAKE_OPTIONS+=${INPUT_CMAKE_CONFIGURATION_TYPE}
