...
if(DEFINED SCLOG_CTEST_TOOLCHAIN_FILE)
  set(CONFIGURE_OPTIONS "-DCMAKE_TOOLCHAIN_FILE=${SCLOG_CTEST_TOOLCHAIN_FILE}")
endif()

list(LENGTH SCLOG_CMAKE_OPTIONS TEST_LIST_LENGTH)
if(DEFINED SCLOG_CMAKE_OPTIONS)
  foreach(SCLOG_CMAKE_OPTION ${SCLOG_CMAKE_OPTIONS})
    set(CONFIGURE_OPTIONS "${CONFIGURE_OPTIONS};-D${SCLOG_CMAKE_OPTION}")
  endforeach()
endif()
...
if(NOT DEFINED SCLOG_CTEST_CMAKE_GENERATOR)
  set(SCLOG_CTEST_CMAKE_GENERATOR "Ninja")
endif()
set(CTEST_CMAKE_GENERATOR ${SCLOG_CTEST_CMAKE_GENERATOR})
